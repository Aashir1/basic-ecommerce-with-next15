...
export const MobileCartItem = () => {
  ...
  return (
    <div className="block md:hidden">
      {/* Table Header */}
      <div className="grid grid-cols-1 border-b pb-2 text-sm font-semibold text-gray-600">
      ...
      {cart.map((item) => (
        <div
          key={item.uuid}
          className="grid-cols-[2fr_1fr] grid items-start gap-[20px] py-[10px] border-b last:border-none border-solitude"
        >
          {/* Product Info */}
          ...
          {/* Price & Subtotal */}
          {/* <div className="text-code-gray text-[18px] font-[400]">${item.price.toFixed(2)}</div> */}
          <div className="flex flex-col items-end">
            <div className="text-right text-code-gray text-[18px] font-[600] mb-[10px]">
